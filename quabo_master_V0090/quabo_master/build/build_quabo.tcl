...
set _xil_proj_name_ "quabo_V0090"
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xc7k160tffg676-1
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../hdl/stim_gen.v"] \
 [file normalize "${origin_dir}/../hdl/in_buf_ds_5bit.v"] \
 [file normalize "${origin_dir}/../hdl/in_buf_ds_1bit.v"] \
 [file normalize "${origin_dir}/../hdl/elapsed_time_gen.v"] \
 [file normalize "${origin_dir}/../hdl/SPI_MUX.v"] \
