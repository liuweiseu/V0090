...
simulate()
{
  xsim base_mb -key {Behavioral:sim_1:Functional:base_mb} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0b46.protoinst" -protoinst "protoinst_files/base_mb.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib fifo_generator_v13_2_3)
