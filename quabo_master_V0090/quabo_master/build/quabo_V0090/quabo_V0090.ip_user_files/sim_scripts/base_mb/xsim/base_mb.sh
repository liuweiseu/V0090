...
{
  file="xsim.ini"
  lib_map_path="/home/wei/Software/Vivado/install/Vivado/2018.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib fifo_generator_v13_2_3 axis_infrastructure_v1_1_0 axis_register_slice_v1_1_18 axis_switch_v1_1_18)
